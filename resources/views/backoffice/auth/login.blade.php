...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link href="{{url('backoffice/bower_components/bootstrap/dist/css/bootstrap.min.css')}}" rel="stylesheet"></link>
    <!-- Font Awesome -->
    <link href="{{url('backoffice/bower_components/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet"></link>
    <!-- Ionicons -->
    <link href="{{url('backoffice/bower_components/Ionicons/css/ionicons.min.css')}}" rel="stylesheet"></link>
    <!-- Theme style -->
    <link href="{{url('backoffice/dist/css/AdminLTE.min.css')}}" rel="stylesheet"></link>
    <!-- iCheck -->
    <link href="{{url('backoffice/bower_components/iCheck/square/blue.css')}}" rel="stylesheet"></link>    
